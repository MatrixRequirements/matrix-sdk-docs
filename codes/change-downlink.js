...
async function run() {
    ...
    */
    ...
    const spec = specsWithTCs[itemIndex];
    console.log(`Found ${specsWithTCs.length} SPEC Items that have TC downlinks. Choosing ${spec.getId()} at random.`);

    const oldDownlinks = spec.getDownlinks();
